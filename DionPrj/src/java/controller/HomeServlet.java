...
public class HomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("da tai san pham len home");
        int index = 0, nrpp = 24;
        ...
        try {
            ...
            System.out.println("not get index");
        }
        Paging p = new Paging(d.getProd().size(), nrpp, index);
        //hiện tại chúng ta đã có nút home và trang hiện tại
        p.calculate();
